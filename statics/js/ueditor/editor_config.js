...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       ,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //附件上传配置区
        ,fileUrl:"http://dev-local.yuncms.net/index.php?app=attachment&controller=ueditor&action=upfile&catid=6&application=content"               //附件上传提交地址
        ...
        ,webAppKey:"uFtwy5uqdwgqbs6ORTEa8c3P"
