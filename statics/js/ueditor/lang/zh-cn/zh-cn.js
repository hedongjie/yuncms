...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'rowspacingtop':'段前距', 'rowspacingbottom':'段后距', 'highlightcode':'插入代码', 'pagebreak':'分页', 'subtitle':'子标题', 'insertframe':'插入Iframe', 'imagenone':'默认',
        'imageleft':'左浮动', 'imageright':'右浮动', 'attachment':'附件', 'imagecenter':'居中', 'wordimage':'图片转存',
        'lineheight':'行间距','edittd':'单元格', 'customstyle':'自定义标题', 'autotypeset':'自动排版', 'webapp':'百度应用', 'touppercase':'字母大写', 
        'tolowercase':'字母小写','background':'背景','template':'模板','scrawl':'涂鸦'
    },
    'insertorderedlist':{
        'decimal':'1,2,3...',
        'lower-alpha':'a,b,c...',
    ...
    'snapscreen':{
        'static':{
            lang_showMsg:"截图功能需要首先安装截图插件！ ",
            lang_download:"点此下载",
            lang_step1:"第一步，下载截图插件并运行安装。",
