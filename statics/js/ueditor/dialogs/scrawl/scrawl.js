...
(function () {
    ...
    scrawl.prototype = {
        ...
        originalState:function (options) {
            ...
            $G("fileForm").action = editor.options.scrawlUrl + "&act=tmpImg" + "&swf_auth_key=" +editor.options.swf_auth_key + "&SWFUPLOADSESSID=" +editor.options.SWFUPLOADSESSID + "&isadmin=" +editor.options.isadmin + "&userid=" +editor.options.userid + "&groupid=" +editor.options.groupid;//初始form提交地址
...
function exec(scrawlObj) {
    if (scrawlObj.isScrawl) {
        ...
        if(!!base64){
            ajax.request(editor.options.scrawlUrl + "&swf_auth_key=" +editor.options.swf_auth_key + "&SWFUPLOADSESSID=" +editor.options.SWFUPLOADSESSID + "&isadmin=" +editor.options.isadmin + "&userid=" +editor.options.userid + "&groupid=" +editor.options.groupid, {
                timeout:100000,
                content:base64,
