 ...
 * @version $Id: Chinabank.php 520 2012-12-02 17:08:32Z xutongle $
 */
        ...
        if ($receive_data) {
            ...
            if ($v_md5str==$md5string) {
                ...
                if($v_pstatus=="20") {
                    ...
                    error_log(date('m-d H:i:s',TIME).'| chinabank GET: order_status=30 |'."\r\n", 3, DATA_PATH.'log/pay_error_log.php');
                    return false;
                }
            } else {
        ...
        if ($receive_data) {
            ...
            if ($v_md5str==$md5string) {
                ...
                if($v_pstatus=="20") {
                    ...
                    error_log(date('m-d H:i:s',TIME).'| chinabank notify: order_status=30 |'."\r\n", 3, DATA_PATH.'log/pay_error_log.php');
                    return false;
                }
            } else {
                return false;
            ...
            error_log(date('m-d H:i:s',TIME).'| notify: no return |'."\r\n", 3, DATA_PATH.'log/pay_error_log.php');
            return false;
        }
    }
