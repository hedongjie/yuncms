...
?>
<div class="pad-lr-10">
<form name="myform" action="?app=message&controller=message&action=delete_inbox" method="post" onsubmit="checkuid();return false;">
...
function checkuid() {
	...
	if(ids=='') {
		window.top.art.dialog.tips('<?php echo L('select_operations')?>');
		return false;
	} else {
		myform.submit();
	}
