 ...
 * @version $Id: IndexController.php 252 2012-11-07 14:52:09Z xutongle $
 */
class IndexController extends foreground {
	...
	public function init() {
		...
		$infos = new_htmlspecialchars ( $infos );
	...
	public function send() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			$subject = new_htmlspecialchars ( $_POST ['info'] ['subject'] );
			$content = new_htmlspecialchars ( $_POST ['info'] ['content'] );
	...
	public function read() {
		...
		if ($infos ['send_from_id'] != 'SYSTEM') $infos = new_htmlspecialchars ( $infos );
		// 查询回复消息
