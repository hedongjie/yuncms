...
?>
<form method="post" action="?app=poster&controller=poster&action=add" id="myform">
...
<tbody>
	...
	<tr>
		...
		<td><?php echo Form::date('poster[startdate]', date('Y-m-d H:i:s', TIME), 1)?></td>
	</tr>
	<tr>
...
$(document).ready(function(){
	...
	$('#name')
		...
		.ajaxValidator({
			type:"get",
			url:"?app=poster&controller=poster&action=public_check_poster",
			data:"",
			datatype:"html",
			cached:false,
			async:'true',
