...
<form action="?app=content&controller=create_html&action=update_urls" method="post" name="myform">
...
<!--
	...
	function change_model(modelid) {
		...
		window.location.href='?app=content&controller=create_html&action=update_urls&modelid='+modelid;
	}
//-->
</script>