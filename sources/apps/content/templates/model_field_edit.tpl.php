...
$(function(){
	...
	$("#field")
		...
		.ajaxValidator({
	    	type : "get",
			url : "?app=content&controller=model_field&action=public_checkfield&modelid=<?php echo $modelid?>&oldfield=<?php echo $field;?>",
			data : "",
			datatype : "html",
			cached:false,
...
<div class="subnav">
  ...
  <div class="content-menu ib-a blue line-x">
	<a href="javascript:;" class="on"><em><?php echo L('edit_field');?></em></a><span>|</span>
	<a href="?app=content&controller=model_field&action=init&modelid=<?php echo $modelid?>&menuid=<?php echo $_GET['menuid']?>"><em><?php echo L('manage_field');?></em></a><span>|</span>
  </div>
  <div class="bk10"></div>
</div>
<form name="myform" id="myform" action="?app=content&controller=model_field&action=edit" method="post">
