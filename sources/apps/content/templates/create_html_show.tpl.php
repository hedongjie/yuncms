...
<form action="?app=content&controller=create_html&action=show" method="post" name="myform">
...
<!--
	...
	function change_model(modelid) {
		window.location.href='?app=content&controller=create_html&action=show&modelid='+modelid+'&hash='+hash;
	}
//-->
</script>