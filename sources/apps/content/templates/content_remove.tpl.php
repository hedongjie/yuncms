...
<div class="content-menu ib-a blue line-x"><a href="?app=content&controller=content&action=init&catid=59" class=on><em><?php echo L('remove');?></em></a>
</div>
<div class="bk10"></div>
<form action="?app=content&controller=content&action=remove" method="post" name="myform">
