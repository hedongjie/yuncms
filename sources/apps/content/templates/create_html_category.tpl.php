...
<form action="?app=content&controller=create_html&action=category" method="post" name="myform">
...
<!--
	...
	function change_model(modelid) {
		window.location.href='?app=content&controller=create_html&action=category&modelid='+modelid+'&hash='+hash;
	}
//-->
</script>