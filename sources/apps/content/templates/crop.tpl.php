...
// 上传地址，使用了 base64 加密
flashvars.uploadurl = "<?php echo base64_encode("index.php?app=attachment&controller=attachments&action=crop_upload&application=$application&catid=$catid&file=".urlencode($picurl));?>";
