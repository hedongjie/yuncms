...
class formguide {
	...
	public function public_cache() {
		...
		foreach ( $classtypes as $classtype ) {
			$cache_data = file_get_contents ( MODEL_PATH . 'formguide_' . $classtype . '.php' );
			...
			$cache_data .= "\r\n } \r\n?>";
			file_put_contents ( CACHE_MODEL_PATH . 'formguide_' . $classtype . '.php', $cache_data );
			@chmod ( CACHE_MODEL_PATH . 'formguide_' . $classtype . '.php', 0777 );
		}
		return true;
	}
}
