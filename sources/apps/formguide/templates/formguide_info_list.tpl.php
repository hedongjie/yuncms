...
?>
    ...
    <div class="btn"><label for="check_box"><?php echo L('selected_all')?>/<?php echo L('cancel')?></label>
		<input name="submit" type="submit" class="button" value="<?php echo L('remove_all_selected')?>" onClick="document.myform.action='?app=formguide&controller=formguide_info&action=public_delete&formid=<?php echo $formid?>';return confirm('<?php echo L('affirm_delete')?>')">&nbsp;&nbsp;</div>  </div>
...
function check(id, did, title){
	window.top.art.dialog.open('?app=formguide&controller=formguide_info&action=public_view&formid='+id+'&did='+did,{
