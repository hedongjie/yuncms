...
　 <?php if(isset($big_menu)) echo '<a class="add fb" href="'.$big_menu[0].'"><em>'.$big_menu[1].'</em></a>　';?><a class="on" href="<?php echo U('formguide/formguide/init');?>"><em><?php echo L('return_list')?></em></a></div>
</div>
<div class="pad-10">
