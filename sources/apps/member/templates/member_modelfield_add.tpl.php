...
$(function(){
	...
	$("#field")
		...
		.ajaxValidator({
	    	type : "get",
			url : "?app=member&controller=member_modelfield&action=public_checkfield",
...
<div class="pad_10">
<form name="myform" id="myform" action="?app=member&controller=member_modelfield&action=add" method="post">
...
<!--
	function field_setting(fieldtype) {
		$.getJSON("?app=member&controller=member_modelfield&action=public_field_setting&fieldtype="+fieldtype, function(data){
