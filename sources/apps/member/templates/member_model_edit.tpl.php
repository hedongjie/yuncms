...
$(function(){
	...
	$("#modelname")
		...
		.ajaxValidator({
	    	type : "get",
			url : "?app=member&controller=member_model&action=public_checkmodelname_ajax&oldmodelname=<?php echo $modelinfo['name']?>",
			data :"",
			datatype : "html",
			async:'false',
...
<form name="myform" action="?app=member&controller=member_model&action=edit" method="post" id="myform">
