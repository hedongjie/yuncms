...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#email")
		...
		.ajaxValidator({
	    	type : "get",
			url : "api.php?c=member&a=checkemail&userid=<?php echo $memberinfo['userid']?>",
			data :"",
			datatype : "html",
			async:'false',
...
<form name="myform" action="?app=member&controller=member&action=edit" method="post" id="myform">
