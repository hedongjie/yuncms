...
<form method="post" action="<?php echo U('vote/vote/setting');?>">
...
function load_file_list(id) {
	$.getJSON('?app=admin&controller=category&action=public_tpl_file_list&style='+id+'&application=vote&templates=vote_tp&name=setting', function(data){$('#show_template').html(data.vote_tp_template);});
}
</script>