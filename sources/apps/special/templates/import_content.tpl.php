...
<form name="myform" id="myform" action="?app=special&controller=special&action=import&specialid=<?php echo $_GET['specialid']?>&modelid=<?php echo $_GET['modelid']?>" method="post">
    <table width="100%">
        <thead>
            <tr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#myform").submit(function (){
			...
			if(str==0) {
				window.top.art.dialog.alert('<?php echo L('choose_news')?>');
				return false;
			}
			return true;
		});
