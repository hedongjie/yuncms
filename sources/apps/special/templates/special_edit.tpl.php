...
?>
<form method="post" action="?app=special&controller=special&action=edit&specialid=<?php echo $_GET['specialid']?>" id="myform">
<div class="pad-10">
<div class="col-tab">
...
$(document).ready(function(){
	...
	$('#title')
		...
		.ajaxValidator({
			type:"get",
			url:"",
			data:"app=special&controller=special&action=public_check_special&id=<?php echo $_GET['specialid']?>",
			datatype:"html",
			cached:false,
			async:'true',
