...
<div class="pad_10">
  <form action="?app=license&controller=client&action=import" method="post" name="myform" id="myform">
    <table cellpadding="2" cellspacing="1" class="table_form" width="100%">
      <tr>
        ...
        <td><select name="license[typeid]" id="">
            ...
            <option
							value="<?php echo $key;?>" <?php if($key==$typeid){echo "selected";}?>><?php echo $val;?></option>
            <?php }?>
          </select></td>
      </tr>
      <tr>
        ...
        <td><input type="text" name="license[sitename]" id="license_name"
					size="30" class="input-text" value="<?php echo $sitename?>"></td>
      </tr>
      <tr>
        <th width="100"><?php echo L('url')?>：</th>
        <td><input type="text" name="license[domain]" id="domain" size="30"
					class="input-text" value="<?php echo $domain['host']?>"></td>
      </tr>
      <tr>
        <th width="100">UUID：</th>
        <td><input type="text" name="license[uuid]" id="uuid" size="50"
					class="input-text" value="<?php echo $uuid?>"></td>
      </tr>
      <tr>
