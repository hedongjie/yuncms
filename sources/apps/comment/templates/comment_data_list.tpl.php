...
<div class="pad-lr-10">
 ...
 <div class="comment_button"><a href="?app=comment&controller=comment_admin&action=lists&show_center_id=1&commentid=<?php echo $commentid?>&hot=0"<?php if (empty($hot)) {?> class="on"<?php }?>>最新</a> <a href="?app=comment&controller=comment_admin&action=lists&show_center_id=1&commentid=<?php echo $commentid?>&hot=1"<?php if ($hot==1) {?> class="on"<?php }?>>最热</a></div>
 ...
 <input type="hidden" name="app" value="comment">
  <input type="hidden" name="controller" value="check">
   <input type="hidden" name="action" value="ajax_checks">
