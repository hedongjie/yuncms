...
<!--
	$(function(){
		...
		$("#subject").formValidator({onshow:"<?php echo L('input').L('player_name');?>",
			...
			.ajaxValidator({type : "get",url : "",data :"app=admin&controller=player&action=public_name&playerid=<?php echo $playerid;?>",datatype : "html",async:'false',
...
<div class="pad_10">
	<form action="<?php echo U('admin/player/edit',array('playerid'=>$playerid));?>" method="post"
		name="myform" id="myform">
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			<tr>
				<th width="70"><?php echo L('player_name');?> :</th>
				<td><input type="text" name="info[subject]" id="subject" size="25"
					value="<?php echo $info['subject'];?>"></td>
			</tr>
			<tr>
				<th><?php echo L('player_code');?> :</th>
				<td><TEXTAREA NAME="info[code]" ROWS="15" COLS="50" id="code"><?php echo $info['code'];?></TEXTAREA><br><?php echo L('player_code_note');?></td>
			</tr>
