...
<div class="pad_10">
	<div class="common-form">
		<form name="myform" action="?app=admin&controller=linkage&action=add"
			...
			<table width="100%" class="table_form contentWrap">
				...
				<tr>
					...
					<td><input name="info[style]" value="0" checked="checked"
						type="radio">&nbsp;<?php echo L('drop_down_style')?>&nbsp;&nbsp;<input
						name="info[style]" value="1" type="radio">&nbsp;<?php echo L('pop_style')?>
</td>
				</tr>
			</table>
