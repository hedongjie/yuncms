...
* {
	...
	margin: 0;
	font-size: 12px;
	font-family: 'Microsoft Yahei', Georgia, Arial;
}
a:link, a:visited {
...
<div class="showMsg" style="text-align: center">
  ...
  <div class="bottom">
    ...
    <input type="button" name="close" value="<?php echo L('close');?> "
    ...
    <?php
					...
					?>
    <a href="<?php echo $url_forward?>"><?php echo L('click_here');?></a> <script
					language="javascript">
    ...
    <?php if ($dialog){?>
    <script style="text/javascript">
		window.top.art.dialog.tips('<?php echo $msg?>', 1);
