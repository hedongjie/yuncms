...
<div class="pad-lr-10">
  <form name="myform" id="myform"
		action="<?php echo U('admin/badword/delete');?>" method="post"
        ...
        <thead>
          <tr>
            <th width="35" align="center"><input type="checkbox" value=""
							id="check_box" onclick="selectall('badid[]');"></th>
	...
	if (is_array ( $infos )) {
		foreach ( $infos as $info ) {
			?>
          <tr>
            <td align="center"><input type="checkbox" name="badid[]"
							value="<?php echo $info['badid']?>"></td>
            <td align="center"><?php echo $info['badword']?></td>
            ...
            <td align="center"><a
							href="javascript:edit(<?php echo $info['badid']?>, '<?php echo new_addslashes($info['badword'])?>')"><?php echo L('edit')?></a> | <a
							href="<?php echo art_confirm(L('badword_confirm_del'),U('admin/badword/delete',array('badid'=>$info['badid'])))?>"><?php echo L('delete')?></a></td>
          </tr>
          <?php
		}
	}
...
function edit(id, name) {
	window.top.art.dialog.open('?app=admin&controller=badword&action=edit&badid='+id,{
		title:'<?php echo L('badword_edit')?> '+name+' ',
		id:'edit',
		width:'450px',
		height:'180px',
