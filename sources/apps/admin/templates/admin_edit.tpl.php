...
<div class="pad_10">
  <div class="common-form">
    <form name="myform" action="?app=admin&controller=admin&action=edit" method="post" id="myform">
      ...
      <table width="100%" class="table_form contentWrap">
        ...
        <tr>
          ...
          <td><input type="text" name="info[email]"
						value="<?php echo $email?>" class="input-text" id="email"
						size="30">
            </input></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="info[mobile]" id="mobile"
						class="input-text" value="<?php echo $mobile?>">
            </input></td>
        </tr>
        <tr>
          <td><?php echo L('realname')?></td>
          <td><input type="text" name="info[realname]"
						value="<?php echo $realname?>" class="input-text" id="realname">
            </input></td>
        </tr>
        ...
        <tr>
          ...
          <td><select name="info[roleid]">
              ...
              <option value="<?php echo $role['roleid']?>"
								<?php echo (($role['roleid']==$roleid) ? 'selected' : '')?>><?php echo $role['rolename']?></option>
              <?php }?>
            </select></td>
        </tr>
        <?php }?>
