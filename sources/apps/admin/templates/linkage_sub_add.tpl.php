...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#name")
		.formValidator({
			onshow:"<?php echo L('input').L('linkage_name').L('linkage_name_desc')?>",
...
<div class="pad_10">
	<div class="common-form">
		<form name="myform"
			action="?app=admin&controller=linkage&action=public_sub_add"
...
<?php echo $list?>
				...
				<tr>
					...
					<td><textarea name="info[name]" rows="2" cols="20" id="name"
							class="inputtext" style="height: 90px; width: 150px;"><?php echo $name?></textarea>
					</td>
				</tr>
			...
			<div class="bk15"></div>
			<input type="hidden" name="keyid" value="<?php echo $keyid?>"> <input
