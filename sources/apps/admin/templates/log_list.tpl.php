...
<div class="pad-lr-10">
	<form name="searchform"
		...
		<table width="100%" cellspacing="0" class="search-form">
			<tbody>
				<tr>
					<td><div class="explain-col"><?php echo L('application')?>: <?php echo Form::select($application_arr,'','name="search[application]"',L('open_application'))?> <?php echo L('username')?>  <input
