...
?>
<span style="margin-right:10px;"><a href="?app=collection&controller=node&action=import_program_del&id=<?php echo $v['id']?>" style="color:#ccc"><?php echo L('delete')?></a></span>
<?php
	}
