...
<td align="center"><a href="javascript:edit(<?php echo $v['id']?>, '<?php echo htmlspecialchars(new_addslashes($v['name']))?>')"><?php echo L('edit')?></a> | <a href="<?php echo art_confirm(htmlspecialchars(new_addslashes(L('confirm', array('message'=>$v['name'])))), '?app=tag&controller=tag&action=del&id='.$v['id']);?>" ><?php echo L('delete')?></a></td>
</tr>
<?php
	endforeach;
endif;
