...
?>
<form method="post" action="<?php echo U('search/search_admin/setting');?>">
<div class="pad_10">
...
function test_sphinx() {
    ...
    $.post('?app=search&controller=search_admin&action=public_test_sphinx',{sphinxhost:$('#sphinxhost').val(),sphinxport:$('#sphinxport').val()}, function(data){
		message = '';
		if(data == 1) {
