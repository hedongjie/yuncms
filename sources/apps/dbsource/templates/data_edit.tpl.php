...
<!--
	$(function(){
		...
		$("#name")
			...
			.ajaxValidator({
				type : "get",
				url : "?app=dbsource&controller=data&action=public_name&id=<?php echo $id?>",
				data :"",
				datatype : "html",
				async:'false',
...
<div class="pad-10">
<form action="?app=dbsource&controller=data&action=edit&id=<?php echo $id?>" method="post" id="myform">
<div>
<fieldset>
    ...
    <td class="y-bg"><?php echo Form::radio(array('0'=>L('model_configuration'), '1'=>L('custom_sql')), isset($type) ? $type : 0, 'name="type" onclick="location.href=\''.Core_Request::get_url().'&type=\'+this.value"')?></td>
  </tr>
  <?php if ($type==0) :?>
    <tr>
