...
<tr>
				<td align="left"><a
					href="<?php echo U('attachment/attachments/album_dir',array('dir'=>stripslashes(dirname($dir))));?>"><img
						src="<?php echo IMG_PATH?>folder-closed.gif" /><?php echo L("parent_directory")?></td>
				</a>
			</tr>
<?php endif;?>
<?php
...
if (is_dir ( $v )) {
			...
			echo '<td align="left"><img src="' . IMG_PATH . 'folder-closed.gif" /> <a href="' . U ( 'attachment/attachments/album_dir', array (
					'dir' => $dir
			) ) . $filename . '"><b>' . $filename . '</b></a></td>';
		} else {
