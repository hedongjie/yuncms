 ...
 * @version $Id: HtmlExtractor.php 2 2013-01-14 07:14:05Z xutongle $
 */
class HtmlExtractor {
	 ...
	 * 取得汉字的个数（目前不太精确)
	 */
	public function chineseCount($str) {
	...
	/**
	 * 判断是不是一个A标签把整个内容都扩上 判断方法：把A标签和它的内容都去掉后，看是否还含有中文
	 */
