 ...
 * @version $Id: Rsa.php 2 2013-01-14 07:14:05Z xutongle $
 */
...
class Crypt_Rsa {
	...
	private static function sign($message, $private_key, $modulus, $keylength) {
	...
	private static function verify($message, $public_key, $modulus, $keylength) {
	...
	private static function pow_mod($p, $q, $r) {
		...
		// Calculate partial results for each factor, using each partial result
		// as a
	...
	// --
	private static function add_PKCS1_padding($data, $isPublicKey, $blocksize) {
