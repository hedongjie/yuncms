<?php
/**
 *  zh-cn.lang.php XTCMS
 *
 * @copyright			(C) 2005-2011 XTCMS
 * @license				http://www.newsteng.com
 * @lastmodify			2011-5-1
 * $Id: template.php 112 2013-03-24 10:42:48Z 85825770@qq.com $
 */
...
$LANG['dir'] = '目录列表';
$LANG['can_edit_files'] = '只能编辑允许的模版文件';
$LANG['find_code'] = '查找节点';
$LANG['file'] = '文件';
$LANG['name'] = '名称';
$LANG['dirs'] = '目录';
...
$LANG['the_application_will_not_support_the_operation'] = '该应用不支持，本次操作！';
$LANG['application_configuration'] = '应用配置';
$LANG['operation'] = '操作';
$LANG['vlan'] = '公共配置';
