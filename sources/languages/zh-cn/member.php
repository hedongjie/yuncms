...
$LANG['agree_protocol_post'] = '注册';
$LANG['already_have_account'] = '已经有了账号？';
$LANG['forget_password_notice'] = '提交后请在一小时内登录邮箱重置会员密码。';
$LANG['or'] = '或';
$LANG['remember'] = '记住';
$LANG['auto_login'] = '下次自动登录';
$LANG['vip'] = 'vip会员';
$LANG['isvip'] = '是否为vip会员';
...
$LANG['denyusername'] = '禁止注册的会员名';
$LANG['denyed_username_setting'] = '可以设置通配符，每个关键字一行，可使用通配符 * 如 陈*桥';
$LANG['denyusername_note'] = '每行一个，回车换行。';
$LANG['denyemail'] = '禁止注册的邮箱';
$LANG['denyemail_note'] = '每行一个，回车换行。';
...
$LANG['uc_on'] = '启用UCenter';
$LANG['uc_off'] = '禁用UCenter';
$LANG['uc_api_host'] = 'Ucenter api 地址：';
$LANG['setting_ucenter_type'] = '请填写接口地址，格式为：http://www.yuncms.net,结尾不包含“/”';
$LANG['uc_api_ip'] = 'Ucenter api IP：';
...
$LANG['setting_ucenter_auth_key'] = '加密密钥长度最小为6位。';
$LANG['must_be_32_w'] = '为UCenter中该设置的密钥';
$LANG['locoy_key_error'] = '格式不对，只能为英文或数字';
$LANG['setting_ucenter_appid'] = '应用ID';
...
$LANG['unbind'] = '解除绑定';
$LANG['no_bind'] = '未绑定';
$LANG['do_bind_account'] = '绑定帐户';
$LANG['bind_success'] = '绑定成功';

$LANG['mobile_bind_tips'] = '在您绑定或换绑手机时，会向您设定的手机上发送验证码，请输入收取到的验证码进行绑定。';
$LANG['unbound_mobile_bind'] = '亲爱的会员，您还未绑定手机，可以在下面输入手机号来进行换绑操作。';
$LANG['Please_input_the_correct_cell_phone_number'] = '请输入正确的手机号码！';
$LANG['SMS_messages_failure'] = '短信发送失败！';
$LANG['sms_ait_1_day'] = '你今天获取验证码次数已达到上限！';
$LANG['Get_text_message_verification_code'] = '获取短信验证码！';
$LANG['To_send_verification_code'] = '秒后可重新发送验证码！';
$LANG['Mobile_phone_number_does_not_agree'] = '您输入的手机号与现在绑定的号码不一致！';
$LANG['your_sms_verification_code_is'] = '您的短信验证码为：';
$LANG['Verification_code_has_been_sent_to'] = '验证码已发送';
$LANG['Verification_code_has_been_sent_to_2'] = '如果超过60秒未收到验证码，您可以免费重新获取。';
$LANG['my_mobile_seccode_is'] = '我收到的手机验证码为';
$LANG['edit_mobile_number_send']='修改号码';
$LANG['edit_mobile_bind']='修改绑定';
$LANG['re_get_sms_seccode']='重获短信验证码';
